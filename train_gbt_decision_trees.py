...
submission_filepath = os.path.join(data_dir, 'validation_labels_gbt_decision_tree.csv')
...
submission_filepath = os.path.join(data_dir, 'submission_gbt_decision_tree.csv')
