...
submission_filepath = os.path.join(data_dir, 'validation_labels_gbt_logistic_regression.csv')
...
submission_filepath = os.path.join(data_dir, 'submission_gbt_logistic_regression.csv')
